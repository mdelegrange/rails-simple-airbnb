...
Flat.create!(
  name: 'Dark & Little Cave Paris',
  address: 'Champs Elysees, 75008 Paris',
  description: 'A lovely winter feel for this tiny cave with no windows. Zero bedroom, close plan living area, no kitchen and no conservatory',
  price_per_night: 150,
  number_of_guests: 6
)
